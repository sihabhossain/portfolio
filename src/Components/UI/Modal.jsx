...
const Modal = ({ activeID, setShowModal }) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
      <div className="max-w-[600px] absolute w-11/12 md:w-full top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5">
        <div>
          <figure>
        ...
        <div>
          ...
          <a href={portfolio.siteUrl} target="_blank">
            <button className="bg-headingColor text-white py-2 px-4 my-8 rounded-[8px] font-[500] hover:bg-purple-500 ease-in duration-300">
              Live Site
            </button>
          </a>
        </div>

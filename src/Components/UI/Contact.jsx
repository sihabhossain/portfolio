    ...
    <section id="contact" className="pb-16 mt-40">
      ...
      <div className="container">
        ...
        <div className="md:flex justify-between items-center">
          ...
          <div className="w-full mt-8 md:mt-0 md:w-1/2 sm:h-[450px] lg:flex items-center bg-smallTextColor px-4 lg:px-8 py-8">
            <form ref={form} onSubmit={sendEmail} className="w-full">
              ...
              <button className="w-full p-3 focus:outline-none rounded-[5px] bg-indigo-600 text-white hover:bg-indigo-700 text-center ease-linear duration-150">
                Send Message
              </button>
            </form>
          </div>
